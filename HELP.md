...
* The original package name 'com.leandro.api-person' is invalid and this project uses 'com.leandro.apiperson' instead.
...
* [Spring for GraphQL](https://docs.spring.io/spring-boot/docs/$3.2.0-SNAPSHOT/reference/htmlsingle/index.html#web.graphql)
